...
export const trafficSignsData: TrafficSignCategory[] = [
  {
    ...
    signs: [
      // Signs with Images (PNG format) - Displayed First
      {
        name: "Stop",
        nameTa: "நிறுத்து",
      ...
      },
      {
        ...
        image: "/traffic-signs/mandatory/speedlimit.png",
      ...
      },
      {
        ...
        nameTa: "வலதுபுறம் திரும்ப வேண்டும்",
        image: "/traffic-signs/mandatory/turnrightahead.png",
        description: "Must proceed ahead or turn right",
        descriptionTa: "முன்னால் செல்ல வேண்டும் அல்லது வலதுபுறம் திரும்ப வேண்டும்",
        color: "blue"
      },
      // Signs with Icons Only - Displayed After Images
      {
      ...
      },
      {
        ...
        nameTa: "காளை வண்டி மற்றும் கைத்தள்ளு வண்டி தடை",
        icon: "🛒🐂🚫",
        description: "Animal-drawn carts and hand carts not allowed",
        descriptionTa: "விலங்குகள் இழுக்கும் வண்டிகள் மற்றும் கைத்தள்ளு வண்டிகள் அனுமதிக்கப்படவில்லை",
        color: "red"
      },
      {
        name: "Bullock Cart Prohibited",
        nameTa: "காளை வண்டி தடை",
        icon: "🐂🚫",
        description: "Animal-drawn carts are not allowed",
        descriptionTa: "விலங்குகள் இழுக்கும் வண்டிகள் அனுமதிக்கப்படவில்லை",
        color: "red"
      },
      {
        name: "Tongas Prohibited",
        nameTa: "குதிரை வண்டி தடை",
        icon: "🐴🚫",
        description: "Horse-drawn carriages are not allowed",
        descriptionTa: "குதிரை வண்டிகள் அனுமதிக்கப்படவில்லை",
        color: "red"
      },
      {
        name: "Hand Cart Prohibited",
        nameTa: "கைத்தள்ளு வண்டி தடை",
        icon: "🛒🚫",
        description: "Hand-pushed carts are not allowed",
        descriptionTa: "கையால் தள்ளும் வண்டிகள் அனுமதிக்கப்படவில்லை",
        color: "red"
      },
      {
        name: "Width Limit",
      ...
      },
      {
        ...
        nameTa: "அச்சு சுமை வரம்பு",
        icon: "⚖️",
        description: "Maximum axle load restriction",
        descriptionTa: "அதிகபட்ச அச்சு சுமை கட்டுப்பாடு",
        color: "red"
      },
      {
        name: "Compulsory Turn Left",
        nameTa: "இடதுபுறம் திரும்ப வேண்டும்",
        icon: "⬅️",
        description: "Must turn left - compulsory direction",
        descriptionTa: "இடதுபுறம் திரும்ப வேண்டும் - கட்டாய திசை",
        color: "blue"
      },
      {
        name: "Compulsory Ahead or Turn Left",
        nameTa: "முன்னால் அல்லது இடதுபுறம் திரும்ப வேண்டும்",
        icon: "↖️",
        description: "Must proceed ahead or turn left",
        descriptionTa: "முன்னால் செல்ல வேண்டும் அல்லது இடதுபுறம் திரும்ப வேண்டும்",
        color: "blue"
      },
      {
      ...
      },
      {
        ...
        nameTa: "சைக்கிள் பாதை கட்டாயம்",
        icon: "🚴",
        description: "Designated cycle track - cyclists must use this path",
        descriptionTa: "நியமிக்கப்பட்ட சைக்கிள் பாதை - சைக்கிள் ஓட்டுபவர்கள் இந்த பாதையை பயன்படுத்த வேண்டும்",
        color: "blue"
      },
      {
  ...
  },
  {
    ...
    signs: [
      ...
      },
      {
        ...
        descriptionTa: "முன்னால் வலது பக்கம் கூர்மையான வளைவு",
        color: "yellow"
      },
      {
      ...
      {
        name: "Hairpin Bend",
        nameTa: "ஹேர்பின் வளைவு",
        image: "/traffic-signs/cautionary/right_hair_pint_bend.png",
        description: "Very sharp U-shaped turn ahead",
        descriptionTa: "முன்னால் மிகவும் கூர்மையான U-வடிவ திருப்பம்",
        color: "yellow"
      },
      {
        name: "Steep Ascent",
      ...
      // Road Intersections & Hazards
      {
        name: "Crossroads Ahead",
        nameTa: "முன்னால் குறுக்கு சாலை",
        image: "/traffic-signs/cautionary/crossroad.png",
        description: "Intersection where two roads cross",
        descriptionTa: "இரண்டு சாலைகள் குறுக்கிடும் சந்திப்பு",
        color: "yellow"
      },
      {
        name: "T-Intersection",
        nameTa: "T-சந்திப்பு",
        image: "/traffic-signs/cautionary/majorroadahead.png",
      ...
      },
      {
        ...
        nameTa: "முன்னால் சாலை வேலை",
        image: "/traffic-signs/cautionary/roadwidensahead.png",
        description: "Construction zone - temporary hazards ahead",
        descriptionTa: "கட்டுமான மண்டலம் - முன்னால் தற்காலிக ஆபத்துகள்",
        color: "yellow"
      },
      {
        name: "Men at Work",
        nameTa: "பணியாளர்கள் வேலை செய்கின்றனர்",
        image: "/traffic-signs/cautionary/manatwork.png",
      ...
      {
        name: "Wild Animals",
        nameTa: "காட்டு விலங்குகள்",
        image: "/traffic-signs/cautionary/wildanimals.png",
        description: "Animals may cross the road",
        descriptionTa: "விலங்குகள் சாலையை கடக்கலாம்",
        color: "yellow"
      },
      {
        name: "Speed Hump",
        nameTa: "வேக தடை",
        image: "/traffic-signs/cautionary/humborroughroad.png",
        description: "Speed breaker or hump ahead",
        descriptionTa: "முன்னால் வேக தடுப்பு அல்லது உயர்வு",
        color: "yellow"
      },
      {
        name: "Uneven Road",
        nameTa: "சீரற்ற சாலை",
        image: "/traffic-signs/cautionary/humborroughroad.png",
        description: "Physical irregularities in road surface",
        descriptionTa: "சாலை மேற்பரப்பில் உடல் ரீதியான ஒழுங்கின்மைகள்",
        color: "yellow"
      },
      {
        name: "Level Crossing with Barrier",
        nameTa: "தடுப்புடன் கூடிய இரயில் கடவை",
        image: "/traffic-signs/cautionary/gapinmedian.png",
        description: "Railway crossing with gates ahead",
        descriptionTa: "முன்னால் வாயில்களுடன் கூடிய இரயில் கடவை",
        color: "yellow"
      },
      {
        name: "Level Crossing without Barrier",
        nameTa: "தடுப்பு இல்லாத இரயில் கடவை",
        image: "/traffic-signs/cautionary/gapinmedian.png",
    ...
    signs: [
      {
        ...
        descriptionTa: "நியமிக்கப்பட்ட பார்க்கிங் பகுதி கிடைக்கிறது",
        color: "blue"
      },
      {
        name: "Give Way",
        nameTa: "வழி விடுங்கள்",
        icon: "🔻",
        description: "Inverted triangle - prioritize other traffic",
        descriptionTa: "தலைகீழ் முக்கோணம் - மற்ற போக்குவரத்துக்கு முன்னுரிமை கொடுங்கள்",
        color: "white"
      },
      {
      ...
      },
      {
        ...
        icon: "⛽",
        description: "Petrol/diesel pump ahead",
        descriptionTa: "முன்னால் பெட்ரோல்/டீசல் பம்ப்",
        color: "blue"
      },
      {
        name: "Food Available",
        nameTa: "உணவு கிடைக்கும்",
        icon: "🍴",
      ...
      },
      {
        ...
        nameTa: "பொது போக்குவரத்து",
        icon: "🚌",
        description: "Bus stop or public transport facility",
        descriptionTa: "பேருந்து நிறுத்தம் அல்லது பொது போக்குவரத்து வசதி",
        color: "blue"
      },
      {
        name: "Distance Marker",
        nameTa: "தூர குறிப்பான்",
        icon: "🛣️",
        description: "Shows distance to destination in kilometers",
        descriptionTa: "இலக்கு வரை கிலோமீட்டர்களில் தூரத்தை காட்டுகிறது",
        color: "green"
      }
    ]
  }
